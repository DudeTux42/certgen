...
pub fn create_json_interactive(output_path: &str) -> Result<()> {
    ...
    if trainer.is_empty() {
        println!("❌ Trainer darf nicht leer sein!");
        return Ok(());
    }
    ...
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!("Geben Sie die Agendapunkte einzeln ein (Maximal 20 Zeilen, leer = fertig):");
    ...
    loop {
        ...
        let mut cert_data = CertificateData::new(name, main_date, agenda.clone());

        // neue struktur explizit setzen
        cert_data.agenda_items = agenda_items.clone();
    ...
    println!(
        "   certgen batch -t <vorlage.tex> -j {} -o zertifikate",
        output_path
    );
    println!();
